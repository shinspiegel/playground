...
For example, if a character has a **[Strength]** value of 12, their **[STR]** modifier would be 4 (12 divided by 3, rounded down).
...
**Attack Power**: A modifier added to damage dealt in combat.
...
Characters have a Movement Range statistic, which outlines how far they may travel in a set period of time.

**Short move**: This refers to a character's ability to move a short distance. This movement does not consume any action.

**Skirmish move**: This refers to a character's ability to move a medium distance, this uses a [Minor Action](#)

**Full move**: This refers to a character's ability to move a long distance, this uses a [Major Actions](#)
