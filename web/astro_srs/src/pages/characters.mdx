...
Characters are primarily defined by three things: [Classes](#class), [Attributes](#attributes), [Combat Values](#combat-values) and, [Techniques](#techniques) . In addition, they have some non-mechanical [Personal Data](#personal-data-1).
...
On the first level of each class, you receive 2 techniques. For each additional level you receive one extra technique. After level 6 you only receive one technique for every even number level.

<ExampleBox closedText="Techniques per level">

| Level | Total | Details                             |
| :---: | :---: | ----------------------------------- |
|   1   |   2   | Starter 2 techniques, level 1 only. |
|   2   |   3   | Gain one extra, level 1 or 2        |
|   3   |   4   | Gain extra one, up to level 3       |
|   4   |   5   | Gain extra one, up to level 4       |
|   5   |   6   | Gain extra one, up to level 5       |
|   6   |   7   | Gain extra one, up to level 6       |
|   7   |   7   | Does not receive extra.             |
|   8   |   8   | Gain extra one, up to level 8       |
|   9   |   8   | Does not receive extra.             |
|  10   |   9   | Gain extra one, up to level 10      |

</ExampleBox>

Every technique will have an name, type, timing, test, target, cost and effects.

- **Name**: The name of the technique.
- **Type**: The category for the technique, like Black Magic, or Martial arts. Techniques can influence other techniques other techniques of specific types.
- **Action**: This is the action needed to use this technique. Some techniques may have an specific timing for being used.
- **Test**: If the technique have a chance of failure, this is the test used to use it.
- **Target**: What kind, distance and amount of targets that the technique can affect.
- **Cost**: Any cost to use the technique.
- **Effects.**: The description of the technique.
