...
import { asyncStoreData, asyntGetStored, asyntRemoveStored } from "../utils/asyncStorage";
...
const useActions = () => {
  ...
  const register = async (form) => {
    ...
    const request = await fetch(config.api.register, args)
      .then((res) => res.json())
  ...
  const getCompanies = async () => {
    ...
    dispatch({ type: cases.setCompanies, payload: request.docs });
    dispatch({ type: cases.setLoading, payload: false });
  };
  ...
  const getProducts = async () => {
    ...
    const request = await fetch(config.api.products, args)
      .then((res) => res.json())
      .catch((err) => console.log(err));

    dispatch({ type: cases.setProducts, payload: request.docs });
    dispatch({ type: cases.setLoading, payload: false });
  };
  ...
  const updateProduct = async (product) => {
    ...
    await fetch(`${config.api.products}/${product._id}`, args)
      .then((res) => res.json())
      .catch((err) => console.log(err));
  ...
  const createProduct = async (product) => {
    ...
    await fetch(config.api.products, args)
      .then((res) => res.json())
      .catch((err) => console.log(err));
  ...
  const deleteProduct = async (productID) => {
    ...
    await fetch(`${config.api.products}/${productID}`, args)
      .then((res) => res.json())
      .catch((err) => console.log(err));
