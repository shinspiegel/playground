...
const sugestion = require('../machineLearning/suggestionMachine');
...
const index = async (req, res) => {
  try {
    ...
    if (week && year) {
      ...
      const suggestedList = await sugestion(listOwner, 0.3);

      console.log(suggestedList)

      return res.json({ week, year, productsList: suggestedList });
    }
